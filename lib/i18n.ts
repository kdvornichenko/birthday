...
const translations = {
    RU: {
        guests: 'Никогда такого не было и вот опять! Начиная аж с 1975 и каждый следующий год, в одну и ту же дату, происходит событие, которое всем нам так хорошо известно &dash; День Рождения!<br/><br/>Но в этот раз не шуточки, не хухры-мухры, дело серьезное, серьезнее некуда!',
        address: {
            placeText1: 'Зыряновск (Алтай, кому как), ресторан "Эдельвейс"',
            atAddress: 'Адрес:',
            addressText: 'ул. Тохтарова 2 (хотя все и так знают)',
        },
        ...
        formSendedModal: {
            success: 'Отправлено!',
            successAttendedTitle: 'Спасибо! С нетерпением Вас ждем!',
